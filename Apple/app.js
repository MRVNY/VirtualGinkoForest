mapkit.init({
    ...
    var ginkos = [
        {
            coordinate: new mapkit.Coordinate(48.840521, 2.30732),
            title: "Elise Raveaux",
        },
        {
            coordinate: new mapkit.Coordinate(49.239361, 3.999326),
            title: "Philippe Raveaux",
        }
    ]
    ...
    var annotations = ginkos.map(function (landmark) {
